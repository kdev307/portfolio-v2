...
import { Plus, ArrowUpRight, Github, ExternalLink } from "lucide-react";
                ...
                <div className="mt-6 flex justify-end gap-3">
                    {project.links?.map((link) => (
                        <a
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface/50 px-4 py-2 text-sm font-medium text-muted transition-all hover:border-accent/40 hover:text-text"
                        >
